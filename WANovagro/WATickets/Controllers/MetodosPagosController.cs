    ...
    public class MetodosPagosController : ApiController
    {
        ...
        public HttpResponseMessage GetAll([FromUri] Filtros filtros)
        {
            try
            {
                ...
                var Pagos = db.MetodosPagos.Where(a => (filtros.Codigo1 > 0 && filtros.FechaInicial != time && filtros.Codigo2 > 0 ? a.idCaja == filtros.Codigo1 && a.idCajero == filtros.Codigo2 && a.Fecha == filtros.FechaInicial : true)
